...
function line(data, id, xVal, yVal, minVal) {
  ...
  const width = d3.select(id) 
    .node() //traverse hte console, find the div in html, get the width / height property out of it
    .getBoundingClientRect().width; //grab the width of the container, set the visualization to fill the entire space
